    ...
    render() {
        return (    
            <div>
                ...
                <div id="clients" className="container is-hidden-tablet-only">
                    <div className="tile is-12 is-ancestor tile-margin-override">
                        <div className="tile is-child box tile-padding-override border-radius-override">
                            {/* Title */}
                            ...
                            <div className="container">     
                                <div className="content is-inline">
                                    <Carousel
                                        slidesPerPage={6}
                                        autoPlay={3000}
                                        animationSpeed={1500}
