                                    ...
                                    <div className="column">
                                        <div className="card">
                                            ...
                                            <footer className="card-footer">
                                                <a href="https://fredjames.azurewebsites.net/" className="card-footer-item">Preview</a>
                                                <a href="https://github.com/freddie2025/PersonalPortfolio" className="card-footer-item">Source Code</a>
                                            </footer>
                                        </div>
                                    </div>
                                    <div className="column">
